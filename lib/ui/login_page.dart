...
import 'package:responsi_2_mobile_h1d023094/bloc/login_bloc.dart';
...
import 'package:responsi_2_mobile_h1d023094/ui/registrasi_page.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Login Nopalmart'),
